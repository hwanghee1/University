...
//정말삭제하시겠습니까?
public class Book_Refusewindow implements ActionListener {
	public void actionPerformed(ActionEvent arg0) {
		...
		button1.addActionListener(new Book_del_Listener(CurTable.curjt, CurTable.curdt));
