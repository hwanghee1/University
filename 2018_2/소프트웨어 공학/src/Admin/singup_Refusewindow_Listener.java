...
//정말 거절하시겠습니까?
public class singup_Refusewindow_Listener implements ActionListener {
	public void actionPerformed(ActionEvent arg0) {
		...
		button1.addActionListener(new Signup_refuse_Listener(CurTable.curjt, CurTable.curdt));
